...
if command -v tmux >/dev/null 2>&1; then
  ...
  tmux new-session -d -s "$SESSION_NAME" "cd '$REPO_ROOT' && bash scripts/run_hmmwv_v07_tire_normal_force_omega_300g_crm2000_mix25_rebal_rollout_onehot_training.sh >> '$RUN_LOG_ABS' 2>&1"
