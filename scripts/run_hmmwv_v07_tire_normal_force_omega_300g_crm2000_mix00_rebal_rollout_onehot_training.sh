...
CONFIG="${CONFIG:-configs/hmmwv_transformer_v07_tire_normal_force_omega_300g_crm2000_mix00_rebal_rollout_onehot.json}"
...
write_status "running" "$current_stage" "rebalanced-loss + rollout-selection training (100% flat / 0% CRM ablation)"
